...
00000000 <main>:
  ...
  17:	7e 10                	jle    29 <main+0x29>
  19:	83 ec 0c             	sub    $0xc,%esp
  1c:	ff 70 04             	pushl  0x4(%eax)
  1f:	e8 ce 02 00 00       	call   2f2 <chdir>
  24:	e8 59 02 00 00       	call   282 <exit>
  29:	50                   	push   %eax
  2a:	50                   	push   %eax
  2b:	68 f0 06 00 00       	push   $0x6f0
  30:	6a 01                	push   $0x1
  32:	e8 99 03 00 00       	call   3d0 <printf>
  37:	e8 46 02 00 00       	call   282 <exit>
  3c:	66 90                	xchg   %ax,%ax
  3e:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 36f:	f7 f6                	div    %esi
 371:	0f b6 92 0c 07 00 00 	movzbl 0x70c(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 4e8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 4eb:	b8 04 07 00 00       	mov    $0x704,%eax
...
00000570 <free>:
 ...
 5c9:	a3 a4 09 00 00       	mov    %eax,0x9a4
 5ce:	5b                   	pop    %ebx
 5cf:	5e                   	pop    %esi
 5d0:	5f                   	pop    %edi
 5d1:	5d                   	pop    %ebp
 ...
 5ed:	a3 a4 09 00 00       	mov    %eax,0x9a4
...
00000600 <malloc>:
 ...
 661:	39 05 a4 09 00 00    	cmp    %eax,0x9a4
 ...
 68b:	8b 15 a4 09 00 00    	mov    0x9a4,%edx
 ...
 6af:	89 15 a4 09 00 00    	mov    %edx,0x9a4
 ...
 6c6:	c7 05 a4 09 00 00 a8 	movl   $0x9a8,0x9a4
 6cd:	09 00 00 
 6d0:	c7 05 a8 09 00 00 a8 	movl   $0x9a8,0x9a8
 6d7:	09 00 00 
 6da:	b8 a8 09 00 00       	mov    $0x9a8,%eax
 6df:	c7 05 ac 09 00 00 00 	movl   $0x0,0x9ac
 6e6:	00 00 00 
