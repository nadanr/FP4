...
int main(int argc, char *argv[])
{
  ...
  33:	ff 33                	pushl  (%ebx)
  35:	e8 38 03 00 00       	call   372 <mkfile>
  3a:	83 c4 10             	add    $0x10,%esp
  3d:	85 c0                	test   %eax,%eax
  3f:	78 23                	js     64 <main+0x64>
  ...
  64:	50                   	push   %eax
  65:	ff 33                	pushl  (%ebx)
  67:	68 53 07 00 00       	push   $0x753
  6c:	6a 02                	push   $0x2
  6e:	e8 ad 03 00 00       	call   420 <printf>
      break;}
  73:	83 c4 10             	add    $0x10,%esp
  76:	eb e7                	jmp    5f <main+0x5f>
...
int main(int argc, char *argv[])
{
  ...
  78:	52                   	push   %edx
  79:	52                   	push   %edx
  7a:	68 40 07 00 00       	push   $0x740
  7f:	6a 02                	push   $0x2
  81:	e8 9a 03 00 00       	call   420 <printf>
    exit();
  86:	e8 47 02 00 00       	call   2d2 <exit>
  8b:	66 90                	xchg   %ax,%ax
  8d:	66 90                	xchg   %ax,%ax
  8f:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3bf:	f7 f6                	div    %esi
 3c1:	0f b6 92 90 07 00 00 	movzbl 0x790(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 538:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 53b:	b8 86 07 00 00       	mov    $0x786,%eax
